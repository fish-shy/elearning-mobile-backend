...
export const uploadToGCS = (file: Express.Multer.File, folder: string = 'uploads'): Promise<string> => {
...
export const getSignedUrl = async (fileName: string, expiresInMinutes: number = 60): Promise<string> => {
  const options = {
    version: 'v4' as const,
