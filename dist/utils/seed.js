...
async function main() {
    ...
    await prisma_1.default.submission.deleteMany();
    await prisma_1.default.assignment.deleteMany();
    await prisma_1.default.lesson.deleteMany();
    await prisma_1.default.enrollment.deleteMany();
    await prisma_1.default.course.deleteMany();
    await prisma_1.default.user.deleteMany();
    await prisma_1.default.fileMetadata.deleteMany();
    console.log('📁 Creating file metadata...');
    const profileImage1 = await prisma_1.default.fileMetadata.create({
        data: {
    ...
    const profileImage2 = await prisma_1.default.fileMetadata.create({
        data: {
    ...
    const profileImage3 = await prisma_1.default.fileMetadata.create({
        data: {
    ...
    const profileImage4 = await prisma_1.default.fileMetadata.create({
        data: {
    ...
    const profileImage5 = await prisma_1.default.fileMetadata.create({
        data: {
    ...
    const profileImage6 = await prisma_1.default.fileMetadata.create({
        data: {
    ...
    const lessonFile1 = await prisma_1.default.fileMetadata.create({
    ...
    const lessonFile2 = await prisma_1.default.fileMetadata.create({
    ...
    const lessonFile3 = await prisma_1.default.fileMetadata.create({
    ...
    const lessonFile7 = await prisma_1.default.fileMetadata.create({
    ...
    const submissionFile4 = await prisma_1.default.fileMetadata.create({
    ...
    const submissionFile5 = await prisma_1.default.fileMetadata.create({
    ...
    const teacher1 = await prisma_1.default.user.create({
        data: {
    ...
    const teacher2 = await prisma_1.default.user.create({
        data: {
    ...
    const student1 = await prisma_1.default.user.create({
        data: {
    ...
    const student2 = await prisma_1.default.user.create({
        data: {
    ...
    const student3 = await prisma_1.default.user.create({
        data: {
    ...
    const course1 = await prisma_1.default.course.create({
        data: {
    ...
    const course2 = await prisma_1.default.course.create({
        data: {
    ...
    const course3 = await prisma_1.default.course.create({
        data: {
    ...
    const course4 = await prisma_1.default.course.create({
        data: {
    ...
    const enrollment1 = await prisma_1.default.enrollment.create({
        data: { studentId: student1.id, courseId: course1.id, completedLessonIds: [] },
    });
    const enrollment2 = await prisma_1.default.enrollment.create({
        data: { studentId: student1.id, courseId: course2.id, completedLessonIds: [] },
    });
    const enrollment3 = await prisma_1.default.enrollment.create({
        data: { studentId: student1.id, courseId: course3.id, completedLessonIds: [] },
    });
    const enrollment4 = await prisma_1.default.enrollment.create({
        data: { studentId: student2.id, courseId: course1.id, completedLessonIds: [] },
    });
    const enrollment5 = await prisma_1.default.enrollment.create({
        data: { studentId: student2.id, courseId: course4.id, completedLessonIds: [] },
    });
    const enrollment6 = await prisma_1.default.enrollment.create({
        data: { studentId: student3.id, courseId: course2.id, completedLessonIds: [] },
    });
    const enrollment7 = await prisma_1.default.enrollment.create({
        data: { studentId: student3.id, courseId: course3.id, completedLessonIds: [] },
    });
    const enrollment8 = await prisma_1.default.enrollment.create({
    ...
    const lesson1_1 = await prisma_1.default.lesson.create({
        data: {
            title: 'HTML Basics',
    ...
    const lesson1_2 = await prisma_1.default.lesson.create({
        data: {
            title: 'CSS Styling',
    ...
    const lesson1_3 = await prisma_1.default.lesson.create({
        data: {
    ...
    const lesson2_1 = await prisma_1.default.lesson.create({
        data: {
    ...
    const lesson2_2 = await prisma_1.default.lesson.create({
        data: {
    ...
    const lesson3_1 = await prisma_1.default.lesson.create({
        data: {
            title: 'SQL Basics',
    ...
    const lesson3_2 = await prisma_1.default.lesson.create({
        data: {
    ...
    const lesson4_1 = await prisma_1.default.lesson.create({
        data: {
    ...
    await prisma_1.default.submission.create({
        data: {
